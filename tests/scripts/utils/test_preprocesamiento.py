...
@pytest.mark.parametrize(
    "valor,intervalos,respuesta_esperada",
    [
        (37, ((30, 50, 1), (60, 70, 2), (70, 100, 3)), 1),
        (12, ((-float("inf"), 15, 3), (15, 20, 2), (21, float("inf"), 1)), 3),
...
def test_evaluar_Intervalo(valor, intervalos, respuesta_esperada):
    ...
    """
    assert evaluar_intervalo(valor, intervalos) == respuesta_esperada
...
def test_86():
    ...
    """
    INSTANCIA = {
        "Inmovilidad_de_M_inferiores": [1],
        "Procedimiento_Quirurgicos___Traumatismo_Grave_en_los_últimos_15_dias": [0],
        "Viaje_prolongado": [0],
        "Síntomas_disautonomicos": [0],
        "Edema_de_M_inferiores": [1],
        "Diabetes_Mellitus": [0],
        "Hipertensión_arterial": [1],
        ...
        "Saturación_de_la_sangre": [95],
        "Frecuencia_cardíaca": [85],
        "WBC": [8000],
        "HB": [14],
        "PLT": [300000],
        "Género": [0],
    ...
    RES = {
        ...
        "Presión_sistólica": [4],
        "Presión_diastólica": [5],
        "Saturación_de_la_sangre": [10],
        "Frecuencia_cardíaca": [2],
        "WBC": [2],
        "HB": [5],
        "PLT": [4],
        "Género": [0],
